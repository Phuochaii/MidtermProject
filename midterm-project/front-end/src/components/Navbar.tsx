...
export default function Navbar({ OnToggleSideBar, fullname }: NavbarProp) {
  ...
  return (
    <div className="flex justify-between bg-white p-4 border-b-2 border-emerald-300 w-screen sticky top-0 z-10">
      <div className="flex items-center space-x-4 ">
        <div
          className="hover:bg-emerald-50 rounded-full p-2 text-emerald-500"
            ...
            <ul className="flex flex-col space-y-4">
              <li>
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-8 h-8 m-auto bg-zinc-600 rounded-full"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <li>
                <Link
                  to="/auth/edit"
                  className="whitespace-nowrap hover:bg-slate-200 p-2 rounded-lg"
                >
                  Chỉnh sửa thông tin
                </Link>
              </li>
